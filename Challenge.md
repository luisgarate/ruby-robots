...
`curl -X POST -H 'Content-type: application/json' --data '{"text":"Hello, World!"}' https://hooks.slack.com/services/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`

You can check the details here:
https://api.slack.com/docs/messages
Note: The URL =>  https://hooks.slack.com/services/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 is a real URL, it will post the message you will format to the person who is reviewing the challenge.
